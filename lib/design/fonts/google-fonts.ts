...
//
// 2026-05-24 TB12 fix:
//   - extractGoogleFontHref added (server-safe, no DOM) for DynamicFontLoaderGlobal

import { AppError } from '@/lib/contracts/errors'
import type { FontInfo, GoogleFont, GoogleFontsAPIResponse } from '@/lib/design/contract/fonts'
import { extractFontFamily } from '@/lib/design/fonts'
...
// Server-safe: extract Google Fonts CSS URL from a CSS font-family string.
// Returns null for system fonts (ui-sans-serif, system-ui, Geist, etc) or
// undefined/empty input. Used by DynamicFontLoaderGlobal (RSC) in app/layout.tsx
// to emit <link> tags in <head> server-side, eliminating FOUC for custom fonts.
//
// Example: extractGoogleFontHref('Poppins, sans-serif') →
//   'https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&display=swap'
// Example: extractGoogleFontHref('system-ui') → null
export function extractGoogleFontHref(
  ...
  return buildFontCssUrl(family, weights)
}
