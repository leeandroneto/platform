// RESEARCH: tweakcn (Apache-2.0) — copied from utils/registry/tailwind-colors.ts
// See NOTICE.md.
//
// ADAPT: import paths → @/lib/design/contract/index (ValidTailwindShade lives there).
// Original imported from @/types (tweakcn root).

import type { ValidTailwindShade } from '@/lib/design/contract/index'
