...
- Ou import de template oficial (`public.specialty_templates` clonável)
...
- Crédito legal obrigatório no rodapé: *"Dados nutricionais: TBCA (USP/FORC) e TACO (NEPA/UNICAMP)."*
