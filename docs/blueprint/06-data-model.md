...
> Causa raiz: schema rígido pra tudo no onboarding-bio gerou 4 system\_\* tabelas 0-row + 1 tabela monstro 51 cols.
...
## 3. Core tabelas dia 0 (~27 tabelas — migration baseline `0001_initial`)

### 3.1 `public.*` (cross-cutting catálogos — ~6)
...
### 3.4 Templates editáveis pelo prof (Pacote B/C — schema dia 0, UI Sprint 6+)
